...
import com.findhouse.base.ApiDataTableResponse;
import com.findhouse.base.ApiResponse;
import com.findhouse.base.HouseOperation;
...
import com.findhouse.service.house.IQiNiuService;
...
import com.findhouse.web.form.DatatableSearch;
import com.findhouse.web.form.HouseForm;
    ...
    public ApiResponse uploadPhoto(@RequestParam("file")MultipartFile file){
        ...
        try {
            ...
            try {
                ...
                return ApiResponse.ofStatus(ApiResponse.Status.INTERNAL_SERBER_ERROR);
            }
        }catch (IOException e) {
            return ApiResponse.ofStatus(ApiResponse.Status.INTERNAL_SERBER_ERROR);
        }
