...
import com.findhouse.repository.HouseDetailRepository;
import com.findhouse.repository.HouseRepository;
import com.findhouse.repository.HouseTagRepository;
import com.findhouse.repository.SupportAddressRepository;
...
//        House house = houseRepository.findOne(houseId);
//        if (house == null){
//            logger.error("Index house {} dose not exist");
//            return false;
//        }
//        HouseIndexTemplate indexTemplate = new HouseIndexTemplate();
//        modelMapper.map(house,indexTemplate);
    ...
    private boolean create(HouseIndexTemplate indexTemplate){
        ...
        try {
            IndexResponse indexResponse = this.esClient.prepareIndex(INDEX_NAME, INDEX_TYPE)
                    ...
                    .get();
            logger.debug("Create index with hosue: " + indexTemplate.getHouseId());
            ...
            logger.error("Error to inde hosue "+ indexTemplate.getHouseId(),e);
            return false;
        }
    }
...
//    }
    ...
    public ServiceResult<List<String>> suggest(String prefix) {
        CompletionSuggestionBuilder suggestion = new CompletionSuggestionBuilder("suggest").text(prefix).size(100);
    ...
    private boolean updateSuggest(HouseIndexTemplate indexTemplate) {
        AnalyzeRequestBuilder requestBuilder = new AnalyzeRequestBuilder(
                ...
                indexTemplate.getTraffic(), indexTemplate.getRoundService(),indexTemplate.getSubwayLineName(),
